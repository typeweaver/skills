...
- Delete or rewrite a test that restates the implementation; it protects
  nothing and breaks on every sound refactor. Consult `ask-kent-beck` when the
  right feedback mechanism is unclear.
