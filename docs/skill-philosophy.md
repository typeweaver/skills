...
- Forward-test new skills and behavior-sensitive revisions in clean contexts
  ...
  one of three exits before the change is ready:

  - **Harder scenario** — build the case that would separate the arms and run it.
  ...
  Handing the choice back untaken is not one of the three.
